...
public class SmartConfigPresenter implements SmartConfigConstract.Presenter, SearchDeviceManager.ISearchDeviceListener {
    ...
    private void startConfig() {
        ...
        LogUtil.debugLog("rrrrr","directory::"+directory);
        ...
        LCSmartConfig.startConfig(mDeviceSnCode, ssid, ssid_pwd, encryptionCap, LCSmartConfig.ConfigType.LCConfigWifi_Type_ALL, fileAudio.getAbsolutePath(),enableBgMusic,11000, fskTxMode);
